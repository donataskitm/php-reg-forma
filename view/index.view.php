    ...
    ?>
        ...
        <form name="regforma" action="#" method="post" id="regforma">
            <table align="center" border="0" >
                ...
                <tr>
                    <td><lable for="repassword">Patvirtinti slaptažodį:<span class="zv">*<span></lable></td>
                ...
                <tr>
                    <td>
                        <h3>Patikrinkite sąskaitos adresą</h3>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td><lable for="street">Gatvė, namo(buto nr.):<span class="zv">*<span></lable></td>
                    <td><input type="text" name="street" id="street" size="15" required><input type="text" name="houseno" id="houseno" size="10">
                    </td>
                </tr>
                <tr>
                    <td><lable for="postcode">Pašto kodas:<span class="zv">*<span></lable></td>
                ...
                <tr>
                    <td><lable for="country">Šalis:<span class="zv">*<span></lable></td>
                    <td>
                ...
                <tr>
                    <td></td>
                    <td><p class="lygl tx">Prašome užpildyti visus pažymėtus laukus</p> </td>
                </tr>
                <tr>
